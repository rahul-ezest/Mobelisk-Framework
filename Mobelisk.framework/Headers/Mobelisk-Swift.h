...
typedef SWIFT_ENUM(NSInteger, ActionButtonDirection, closed) {
/// Action Button 0.
  ActionButtonDirectionOutput = 0,
/// Action Button 1.
  ActionButtonDirectionInput = 1,
/// Action Button Unknown.
  ActionButtonDirectionUnknown = 2,
};

typedef SWIFT_ENUM(NSInteger, ActionButtonEnableStatus, closed) {
/// Action Button 0.
  ActionButtonEnableStatusEnable = 0,
/// Action Button 1.
  ActionButtonEnableStatusDisable = 1,
/// Action Button Unknown.
  ActionButtonEnableStatusUnknown = 2,
};

typedef SWIFT_ENUM(NSInteger, ActionButtonNumber, closed) {
/// Action Button 0.
...
SWIFT_CLASS("_TtC8Mobelisk18ActionButtonResult")
@interface ActionButtonResult : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
/// The LedNumber enum is used to address LEDs when sending commands to turn on or off LEDs on the Enterprise Appliance Module.
/// LEDs are numbered starting from 0.
/// In most modules the LED number ‘ActionLedNumber’ will correspond to the ‘ButtonNumber’ button number.
typedef SWIFT_ENUM(NSInteger, ActionLedNumber, closed) {
/// Action LED 0
...
SWIFT_CLASS("_TtC8Mobelisk15AngularVelocity")
@interface AngularVelocity : NSObject
/// x angle of device
...
/// Default initializer.
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// Interface which provide historical barcode scanned details.
/// \param count Optional number of barcode scanned needed.
///
/// \param completionHandler <em>@escaping</em> completionHandler which will return - the Shock event data.
///
- (void)getHistoricalBarcodeScannedWithCount:(NSInteger)count completionHandler:(void (^ _Nonnull)(NSArray<Barcode *> * _Nullable, NSError * _Nullable))completionHandler;
...
///
+ (void)setScanMode:(enum ScanMode)scanMode completionHandler:(void (^ _Nonnull)(NSError * _Nullable))completionHandler;
...
typedef SWIFT_ENUM(NSInteger, BoardType, closed) {
...
typedef SWIFT_ENUM(NSInteger, BuildConfiguration, closed) {
  BuildConfigurationDebug = 0,
  BuildConfigurationLive = 1,
};
...
typedef SWIFT_ENUM(NSInteger, ButtonNumber, closed) {
...
typedef SWIFT_ENUM(uint8_t, CaseChargingStatus, closed) {
/// notCharging
...
typedef SWIFT_ENUM(uint8_t, ChargerStatus, closed) {
/// notCharging
...
typedef SWIFT_ENUM(uint8_t, DeviceChargingStatus, closed) {
/// notCharging
...
SWIFT_CLASS("_TtC8Mobelisk9Direction")
@interface Direction : NSObject
/// x magnitude of device
@property (nonatomic, readonly) float x;
/// y magnitude of device
@property (nonatomic, readonly) float y;
/// z magnitude of device
@property (nonatomic, readonly) float z;
/// timestamp at which data captured
@property (nonatomic, readonly, copy) NSDate * _Nonnull timeStamp;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
...
SWIFT_CLASS("_TtC8Mobelisk19EActionButtonResult")
@interface EActionButtonResult : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end

/// Enum for Sensor’s EndCap number
typedef SWIFT_ENUM(NSInteger, EndCapNumber, closed) {
...
///
+ (void)registerForEAButtonNotificationWithIdentifier:(NSString * _Nonnull)identifier completionHandler:(void (^ _Nonnull)(NSArray<EActionButtonResult *> * _Nonnull))completionHandler;
...
/// \param completionHandler <em>@escaping</em> completionHandler which will return - the button state report.
///
+ (void)registerForActionButtonNotificationWithIdentifier:(NSString * _Nonnull)identifier completionHandler:(void (^ _Nonnull)(NSArray<ActionButtonResult *> * _Nonnull))completionHandler;
...
/// TimeStamp
@property (nonatomic, readonly, copy) NSDate * _Nonnull timeStamp;
@property (nonatomic, readonly) float heatIndex;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
typedef SWIFT_ENUM(uint8_t, FunctionalState, closed) {
/// unknown
...
SWIFT_CLASS("_TtC8Mobelisk3IMU")
@interface IMU : NSObject
/// x angle of device
@property (nonatomic, readonly, strong) Acceleration * _Nonnull acceleration;
/// y angle of device
@property (nonatomic, readonly, strong) AngularVelocity * _Nonnull angularVelocity;
/// z angle of device
@property (nonatomic, readonly, strong) Direction * _Nonnull direction;
/// timestamp at which data captured
@property (nonatomic, readonly, copy) NSDate * _Nonnull timeStamp;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
...
/// IMU report.
/// The IMU report provides an interface to get IMU details. Registering for notification will give updated IMU data at defined time.
SWIFT_CLASS("_TtC8Mobelisk9IMUReport")
@interface IMUReport : NSObject
/// Default initializer.
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
/// Returns the current IMU details.
/// \param completionHandler <em>@escaping</em> completionHandler which will return - the IMU data.
///
- (void)getIMUDetailsWithCompletionHandler:(void (^ _Nonnull)(IMU * _Nullable, NSError * _Nullable))completionHandler;
/// Interface definition for a callback to be invoked when a IMU data is received.
/// \param identifier Identifier which will be used while de-registering for notification.
///
/// \param duration Time interval at which IMU data needed
///
/// \param completionHandler <em>@escaping</em> completionHandler which will return - the IMU data.
///
+ (void)registerForNotificationWithIdentifier:(NSString * _Nonnull)identifier atTimeInterval:(NSTimeInterval)duration completionHandler:(void (^ _Nonnull)(IMU * _Nonnull))completionHandler;
/// Interface definition to de-register for IMU notifications.
+ (void)deRegisterForNotificationWithIdentifier:(NSString * _Nonnull)identifier;
@end
...
/// LEDs are numbered starting from 0.
typedef SWIFT_ENUM(NSInteger, LedNumber, closed) {
...
typedef SWIFT_ENUM(NSInteger, MPOSDeviceConnection, closed) {
...
/// Model class for Main board information
SWIFT_CLASS("_TtC8Mobelisk9MainBoard")
...
@protocol PeripheralDetailDataSource;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) SmartCaseDetails * _Nullable connectedSmartCase;)
+ (SmartCaseDetails * _Nullable)connectedSmartCase SWIFT_WARN_UNUSED_RESULT;
/// Build the framework with MobeliskConfig model.
+ (void)buildWithConfiguration:(MobeliskConfig * _Nonnull)config peripheralDetailDataSource:(id <PeripheralDetailDataSource> _Nullable)peripheralDetailDataSource;
@end
...
@interface MobeliskManager (SWIFT_EXTENSION(Mobelisk))
+ (void)launchDiagnosticOptionsForEnvironment:(enum BuildConfiguration)environment;
@end


/// Model class for Motion data
SWIFT_CLASS("_TtC8Mobelisk6Motion")
...
/// Motion report.
/// The motion report provides an interface to get device motion details. Registering for notification will provide motion or orientation changes.
SWIFT_CLASS("_TtC8Mobelisk12MotionReport")
@interface MotionReport : NSObject
/// Interface which provide historical motion details from provided start date to date.
/// \param fromDate from historical date.
///
/// \param toDate to historical date.
///
/// \param timeZone Optional timeZone in which fromDate/toDate should consider.
///
/// \param completionHandler <em>@escaping</em> completionHandler which will return - the Motion data.
///
- (void)getHistoricalMotionDetailsFromDate:(NSDate * _Nonnull)fromDate toDate:(NSDate * _Nonnull)toDate timeZone:(NSTimeZone * _Nullable)timeZone completionHandler:(void (^ _Nonnull)(NSDictionary<NSDate *, NSArray<OperationTime *> *> * _Nullable))completionHandler;
/// Interface definition for a callback to be invoked when a Motion occurs.
/// \param identifier Identifier which will be used while de-registering for notification.
///
/// \param completionHandler <em>@escaping</em> completionHandler which will return - the Motion data.
///
+ (void)registerForNotificationWithIdentifier:(NSString * _Nonnull)identifier completionHandler:(void (^ _Nonnull)(Motion * _Nonnull))completionHandler;
/// Interface definition to de-register for Motion notifications.
+ (void)deRegisterForNotificationWithIdentifier:(NSString * _Nonnull)identifier;
/// Interface definition to de-register for Motion notifications.
+ (void)deRegisterForNotificationForOperationTimeWithIdentifier:(NSString * _Nonnull)identifier;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
/// Model class for Operation time
SWIFT_CLASS("_TtC8Mobelisk13OperationTime")
@interface OperationTime : NSObject
/// Motion started Date and Time
@property (nonatomic, readonly, copy) NSDate * _Nonnull motionStartedAt;
/// Motion stopped Date and Time
@property (nonatomic, readonly, copy) NSDate * _Nonnull motionStoppedAt;
/// motionId
@property (nonatomic, readonly, copy) NSString * _Nonnull motionId;
/// Motion duration
@property (nonatomic, readonly) double motionTime;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
/// Model class for PCB board information
SWIFT_CLASS("_TtC8Mobelisk8PCBBoard")
@interface PCBBoard : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
enum PeripheralIdentifier : uint16_t;

/// Model class for Peripheral
SWIFT_CLASS("_TtC8Mobelisk10Peripheral")
@interface Peripheral : NSObject
/// Type of peripheral
@property (nonatomic, readonly) enum PeripheralIdentifier type;
/// Power state
...
/// Peripheral spec number
@property (nonatomic, readonly) NSInteger specNumber;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end


/// Peripheral detail data source to send request using third party frameworks.
SWIFT_PROTOCOL("_TtP8Mobelisk26PeripheralDetailDataSource_")
@protocol PeripheralDetailDataSource
/// Request to get serial number from peripheral
- (NSString * _Nonnull)getSerialNumber SWIFT_WARN_UNUSED_RESULT;
/// Request to get firmware version from peripheral
- (NSString * _Nonnull)getFirmwareVersion SWIFT_WARN_UNUSED_RESULT;
@end

typedef SWIFT_ENUM(uint16_t, PeripheralIdentifier, closed) {
  PeripheralIdentifierNone = 0,
  PeripheralIdentifierMagtekMSR = 16,
  PeripheralIdentifierIntermecBCS = 32,
  PeripheralIdentifierZebraBCS = 33,
  PeripheralIdentifierChimeraEA = 49,
  PeripheralIdentifierMinismartII = 64,
  PeripheralIdentifierIdTech4880 = 80,
  PeripheralIdentifierRfidReader = 96,
  PeripheralIdentifierEnterpriseAppliance = 65000,
};

/// Enum for Sensor’s power condition
typedef SWIFT_ENUM(uint8_t, PowerCondition, closed) {
/// Off
  PowerConditionOff = 0,
/// On
  PowerConditionOn = 1,
...
/// Model class for SD Card information
SWIFT_CLASS("_TtC8Mobelisk6SDCard")
@interface SDCard : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end

@class SafeDriverSettings;

/// Safe Driver Manager.
/// The Safe driver manager provides an interface to start tracking device and it’s speed. Based on speed apps on device may hide or show.
SWIFT_CLASS("_TtC8Mobelisk17SafeDriverManager")
@interface SafeDriverManager : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@property (nonatomic, readonly, strong) SafeDriverSettings * _Nullable safeDriverSettings;
@end
...
enum SafeDriverState : NSInteger;

/// Model class for Safe Driver Model
SWIFT_CLASS("_TtC8Mobelisk15SafeDriverModel")
@interface SafeDriverModel : NSObject
/// Current speed
@property (nonatomic, readonly) float currentSpeed;
/// Current state
@property (nonatomic, readonly) enum SafeDriverState currentState;
/// Whitelist start time
@property (nonatomic, readonly) NSTimeInterval whiteListStartTime;
/// Whitelist time remaining
@property (nonatomic, readonly) NSTimeInterval whiteListTimeRemaining;
/// Blacklist start time
@property (nonatomic, readonly) NSTimeInterval blackListStartTime;
/// Blacklist time remaining
@property (nonatomic, readonly) NSTimeInterval blackListTimeRemaining;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end


/// Model class for Safe driver settings
SWIFT_CLASS("_TtC8Mobelisk18SafeDriverSettings")
@interface SafeDriverSettings : NSObject
/// Should allow end user to override settings
@property (nonatomic, readonly) BOOL shouldAllowUserToOverrideSettings;
/// Is safe driver feature enabled
@property (nonatomic, readonly) BOOL isSafeDriverEnabled;
/// Blacklist Speed Threshold
@property (nonatomic, readonly) float blackListSpeedThreshold;
/// Blacklist Above Time Threshold
@property (nonatomic, readonly) NSTimeInterval blackListAboveTimeThreshold;
/// Whitelist Speed Threshold
@property (nonatomic, readonly) float whiteListSpeedThreshold;
/// Whitelist Above Time Threshold
@property (nonatomic, readonly) NSTimeInterval whiteListAboveTimeThreshold;
/// Speed unit
@property (nonatomic, readonly, copy) NSString * _Nonnull speedUnit;
/// time threshold unit
@property (nonatomic, readonly, copy) NSString * _Nonnull timeThresholdUnit;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end

/// Enum represent Safe driver state
typedef SWIFT_ENUM(NSInteger, SafeDriverState, closed) {
/// Driver white listed
  SafeDriverStateWhiteListed = 0,
/// Driver black listed
  SafeDriverStateBlackListed = 1,
};

/// ScanMode enum.
typedef SWIFT_ENUM(uint8_t, ScanMode, closed) {
/// ScanMode - HID.
  ScanModeHid = 0,
/// ScanMode - Serial.
  ScanModeSerial = 1,
...
enum SensorIdentifier : uint16_t;
...
/// Type of sensor
@property (nonatomic, readonly) enum SensorIdentifier type;
/// Sensor name
@property (nonatomic, readonly, copy) NSString * _Nonnull name;
/// Model number
@property (nonatomic, readonly, copy) NSString * _Nonnull modelNumber;
...
typedef SWIFT_ENUM(uint16_t, SensorIdentifier, closed) {
  SensorIdentifierNone = 0,
  SensorIdentifierAccelerometer = 1,
  SensorIdentifierRelativeHumidity = 2,
  SensorIdentifierBarometer = 3,
  SensorIdentifierShockEvent = 4,
  SensorIdentifierInertialMeasurementUnit = 5,
  SensorIdentifierMagnetometer = 51,
  SensorIdentifierThermistor = 6,
};

/// Enum for Sensor’s Status
typedef SWIFT_ENUM(uint8_t, SensorStatus, closed) {
/// idle
...
/// Default initializer.
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// Interface which provide historical shock event details.
/// \param count Optional number of shock events needed.
///
/// \param completionHandler <em>@escaping</em> completionHandler which will return - the Shock event data.
///
- (void)getHistoricalShockEventsWithCount:(NSInteger)count completionHandler:(void (^ _Nonnull)(NSArray<ShockEvent *> * _Nullable))completionHandler;
...
/// Model class for Battery information
SWIFT_CLASS("_TtC8Mobelisk16SmartCaseBattery")
@interface SmartCaseBattery : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
@property (nonatomic, readonly, copy) NSString * _Nonnull bootloaderFirmwareVersion;
/// Main board information
@property (nonatomic, readonly, strong) MainBoard * _Nonnull mainBoard;
/// PCB board information
@property (nonatomic, readonly, strong) PCBBoard * _Nullable pcbBoard;
/// SD Card information
@property (nonatomic, readonly, strong) SDCard * _Nullable sdCard;
/// Battery information
@property (nonatomic, readonly, strong) SmartCaseBattery * _Nullable battery;
/// Board type
@property (nonatomic, readonly) enum BoardType boardType;
/// Model Name
...
@property (nonatomic, readonly, copy) NSArray<Sensor *> * _Nonnull connectedSensors;
@property (nonatomic, readonly, copy) NSArray<Peripheral *> * _Nonnull connectedPeripherals;
@end


/// Smart module report.
/// The smart module report contains all relevant hardware version information needed to identify a case.
...
/// Returns the Barcode number of Endcap #1.
/// \param completionHandler <em>@escaping</em> completionHandler which will return - the barcode number of Endcap #1.
///
- (void)getEndcapOneBarcodeNumberWithCompletionHandler:(void (^ _Nonnull)(NSInteger, NSError * _Nullable))completionHandler;
/// Returns the Barcode number of Endcap #2.
/// \param completionHandler <em>@escaping</em> completionHandler which will return - the barcode number of Endcap #2.
///
- (void)getEndcapTwoBarcodeNumberWithCompletionHandler:(void (^ _Nonnull)(NSInteger, NSError * _Nullable))completionHandler;
